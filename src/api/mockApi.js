...
// Mock data
const mockUsers = [
  { id: '1', name: 'User 1', email: 'user1@company.com', projectIds: ['1', '2'] },
  { id: '2', name: 'User 2', email: 'user2@company.com', projectIds: ['1'] },
  { id: '3', name: 'User 3', email: 'user3@company.com', projectIds: ['2', '3'] },
  { id: '4', name: 'User 4', email: 'user4@company.com', projectIds: ['1', '3'] },
];

const mockProjects = [
  { id: '1', name: 'Project 1', userIds: ['1', '2', '4'] },
  { id: '2', name: 'Project 2', userIds: ['1', '3'] },
  { id: '3', name: 'Project 3', userIds: ['3', '4'] },
];
